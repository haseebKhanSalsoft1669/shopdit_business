...
export default function EcommerceMetrics() {
  ...
  const { data } = useGetBusinessAnalyticsQuery(
    { businessProfileId },
    { skip: !businessProfileId }
  );

  const analytics = data?.data?.summary;
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div className="flex items-end justify-between mt-5">
          <div>
            ...
            <h4 className="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90 animate-pulse">
              {analytics?.totalCouponRedemptions}
            </h4>
          </div>
