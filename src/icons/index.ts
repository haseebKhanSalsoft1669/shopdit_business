...
import { ReactComponent as CoinPayinIcon } from "./coin-payin.svg?react";
import { ReactComponent as CoinRequestIcon } from "./coin-request.svg?react";
...
import { ReactComponent as PayoutIcon } from "./payout.svg?react";
...
import { ReactComponent as PostIcon } from "./post.svg?react";
...
export {
  ...
  ArrowRightIcon, ArrowUpIcon, AudioIcon, BoltIcon, BoxCubeIcon, BoxIcon, BoxIconLine, CalenderIcon, ChatIcon, CheckCircleIcon, CheckLineIcon, ChevronDownIcon, ChevronLeftIcon, ChevronUpIcon, CloseIcon, CloseLineIcon, CoinPayinIcon,
  CoinRequestIcon, CopyIcon, DocsIcon, DollarLineIcon, DownloadIcon, EmailIcon, EnvelopeIcon, ErrorHexaIcon, ErrorIcon, EyeCloseIcon, EyeIcon, FileIcon, FolderIcon, GridIcon, GroupIcon, HorizontaLDots, InfoIcon, InventoryIcon, ListIcon, LockIcon, MailIcon, MoreDotIcon, OrderIcon, PageIcon, PaperPlaneIcon, PayoutIcon, PencilIcon, PieChartIcon, PlugInIcon, PlusIcon, PostIcon,
  ReportIcon, SecurityIcon, SettingsIcon, ShootingStarIcon, TableIcon, TaskIcon, TimeIcon, TrashBinIcon, UserCircleIcon, UserIcon, VideoIcon
};
