...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Shopdit - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Shopdit - React.js Tailwind CSS Admin Dashboard Template"
      />
