...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Shopdit - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Shopdit - React.js Tailwind CSS Admin Dashboard Template"
      />
