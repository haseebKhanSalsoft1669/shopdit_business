    ...
    return (
        <>
            <div className="mb-6 flex items-center justify-between">
                <h1 className="text-2xl font-bold py-2">CAREER MANAGEMENT</h1>
                <button type="button" className="web-btn" onClick={() => navigate("/career-management/create-job")}>CREATE JOB</button>
            </div>
